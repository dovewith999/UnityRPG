...
public class Hero : Creature
{
    ...
    {      
        ...
        if (HeroMoveState == EHeroMoveState.CollectEnv)
        {
            ...
            ChaseOrAttackTarget(SearchDistance, AttackDistance);
            return;
        }
    ...
    void ChaseOrAttackTarget(float chaseRange, float attackRange)
    {
